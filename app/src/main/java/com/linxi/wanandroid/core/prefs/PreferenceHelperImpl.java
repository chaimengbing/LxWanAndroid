package com.linxi.wanandroid.core.prefs;
...
public class PreferenceHelperImpl implements PreferenceHelper {
    ...
    PreferenceHelperImpl() {
        mPreferences = LxWanAndroidApplication.getInstance().getSharedPreferences(Constants.MY_SHARED_PREFERENCE, Context.MODE_PRIVATE);
    }
